...
\lstset{language=R,%
    ...
    emph=[1]{for,end,break},emphstyle=[1]\color{bostonuniversityred}, %some words to emphasise
...
\input{tex/ievads}
% \input{tex/ievads_teorijai}

% * Literatūras apskats
\chapter{Literatūras apskats}
% \input{tex/definicijas}
\input{tex/literatura}
\input{tex/lit_1_saule}
\input{tex/lit_2_saules_kustiba}
\input{tex/lit_3_klimats}
\chapter{Saules paneļi}
\input{tex/pv_1_darbibas_princips}
\input{tex/pv_3_rest}
...
\chapter{Rezultāti}
\input{tex/rezultati}
\input{tex/res_klimats}
\input{tex/res_paneli}


%* Secinājumi
\chapter*{Secinājumi}
\addcontentsline{toc}{chapter}{Secinājumi}
\input{tex/secinajumi}

%* Pateicības
\chapter*{Pateicības}
\addcontentsline{toc}{chapter}{Pateicības}
\input{tex/pateicibas}
