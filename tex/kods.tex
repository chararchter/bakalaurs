% \section{Izveidotās datu apstrāde sistēmas darbības principi}

% VRM piedāvā lejupielādēt aptuveni 300 kolonnu \emph{.csv} failu, turklāt Sistēma arbitrāros laikos ievieš fundamentālas datu struktūras izmaiņas un nepiedāvā programmatūras izstrādātājiem bezmaksas migrāciju, tāpēc datu ielase notiek dinamiski, kas ir ievieš papildu sarezģītību programmā. 
